...
class Assignment {
    ...
    int nobs_time(int g, int j, const Gals&,const MTL& M, const Feat& F) const; // Know the number of remaining observations of g when the program is at the tile j, for pyplotTile
