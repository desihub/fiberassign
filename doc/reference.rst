...
After loading all the data, we build a :class:`scipy.spatial.KDTree` to index these targets spatially for fast querying of targets that lie within some radius of a sky location.
