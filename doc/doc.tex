...
\begin{tikzpicture}[scale=1.1]
	\begin{axis}[enlarge y limits=false,enlarge x limits=false,xlabel={Objects/\sqd},ylabel={},cycle list name=mycolorlist,legend pos=south east]
		\addplot table[x=x,y=0] {figs/seendens.dat};
	\end{axis}
\end{tikzpicture}
\caption{\% of observed galaxies as a function of objects density}\end{center}\end{figure}
\end{comment}
