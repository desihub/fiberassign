# -*- coding: utf-8 -*-
#
# fiberassign documentation build configuration file, created by
...
# which will pick up either the installed version or one that has been built
# in place and added to the environment.  Otherwise we try to import from the
# source tree and raise an error if that does not work.
try:
    import fiberassign
except ImportError:
    ...
    try:
        ...
        print("Before running sphinx, you must have installed / built"
              " fiberassign and have it in your search path, or run"
...
version = fiberassign.__version__.split('-', 1)[0]
# The full version, including alpha/beta/rc tags.
release = fiberassign.__version__
...
for missing in ('numpy', 'scipy', 'matplotlib', 'fitsio', 'astropy',
